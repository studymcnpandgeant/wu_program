...
PetscErrorCode MatXFModel(PetscInt n,PetscInt m,Mat XF,Grid *grid)
{
  PetscInt        II,Iend,Interval1,Interval2,Interval3,j,i;
  PetscErrorCode  ierr;
  ...
  for (II = 0; II < Iend ; II++ ) {
  	i = II/n; j = II-i*n;
    chisigmaf1 = grid->getrzchisigmaf(j,II,chigroup1,group1);
    chisigmaf2 = grid->getrzchisigmaf(j,II,chigroup1,group2);
    chisigmaf3 = grid->getrzchisigmaf(j,II,chigroup1,group3);
    chisigmaf4 = grid->getrzchisigmaf(j,II,chigroup1,group4);
  ...
  for (II = 0; II < Iend ; II++ ) {
  	i = II/n; j = II-i*n;
    chisigmaf1 = grid->getrzchisigmaf(j,II,chigroup2,group1);
    chisigmaf2 = grid->getrzchisigmaf(j,II,chigroup2,group2);
    chisigmaf3 = grid->getrzchisigmaf(j,II,chigroup2,group3);
    chisigmaf4 = grid->getrzchisigmaf(j,II,chigroup2,group4);
  ...
  for (II = 0; II < Iend ; II++ ) {
  	i = II/n; j = II-i*n;
    chisigmaf1 = grid->getrzchisigmaf(j,II,chigroup3,group1);
    chisigmaf2 = grid->getrzchisigmaf(j,II,chigroup3,group2);
    chisigmaf3 = grid->getrzchisigmaf(j,II,chigroup3,group3);
    chisigmaf4 = grid->getrzchisigmaf(j,II,chigroup3,group4);
...
PetscErrorCode MatLModel(PetscInt n, PetscInt m, Mat L,Grid *grid)
{
  ...
  for (II = 0; II<Iend ; II++) {
    ...
    sigmat1 = grid->getrzsigmat(j,II,group1);
    sigmas11 = grid->getrzsigmas(j,II,group1,group1);
   ...
   for (II = 0 ; II<Iend; II++) {
     ...
     sigmat2 = grid->getrzsigmat(j,II,group2);
     sigmas22 = grid->getrzsigmas(j,II,group2,group2);
  ...
  for (II = 0 ; II<Iend; II++) {
     ...
     sigmat3 = grid->getrzsigmat(j,II,group3);
     sigmas33 = grid->getrzsigmas(j,II,group3,group3);
  ...
  for (II = 0 ; II<Iend; II++) {
     ...
     sigmat4 = grid->getrzsigmat(j,II,group4);
     sigmas44 = grid->getrzsigmas(j,II,group4,group4);
     e3 = (sigmat4 - sigmas44) - a3 - d3 - b3 - c3 ;
     ierr = MatSetValue(L,II+Interval3,II+Interval3,e3,INSERT_VALUES);CHKERRQ(ierr);
   }
   for (II = 0; II < Iend ; II++ ) {
     i = II/n; j = II-i*n;
     sigmas12 = - grid->getrzsigmas(j,II,group1,group2); 
     ierr = MatSetValue(L,II+Interval1,II,sigmas12,INSERT_VALUES);CHKERRQ(ierr);
   }
  for (II = 0; II < Iend ; II++ ) {
     i = II/n; j = II-i*n;
     sigmas13 = - grid->getrzsigmas(j,II,group1,group3);
     sigmas23 = - grid->getrzsigmas(j,II,group2,group3); 
  ...
  for (II = 0; II < Iend ; II++ ) {
     i = II/n; j = II-i*n;
     sigmas14 = - grid->getrzsigmas(j,II,group1,group4);
     sigmas24 = - grid->getrzsigmas(j,II,group2,group4);
     sigmas34 = - grid->getrzsigmas(j,II,group3,group4); 
