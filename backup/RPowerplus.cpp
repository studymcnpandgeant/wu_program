...
void RPowerplus::setinitial(PetscScalar *array1,PetscScalar *array2,PetscScalar *array3,PetscScalar *array4,PetscScalar *array5,PetscScalar *array6,PetscScalar *array7,PetscScalar *array8,PetscScalar *array9)
{
...
PetscScalar RPowerplus::geta1(PetscInt i, PetscInt j, PetscInt group)
{
...
PetscScalar RPowerplus::geta2(PetscInt i, PetscInt j, PetscInt group)
{
...
PetscScalar RPowerplus::geta3(PetscInt i, PetscInt j, PetscInt group)
{
...
PetscScalar RPowerplus::geta4(PetscInt i, PetscInt j, PetscInt group)
{
...
PetscScalar RPowerplus::geta0(PetscInt i, PetscInt j, PetscInt group, PetscScalar a1, PetscScalar a2, PetscScalar a3, PetscScalar a4)
{
	PetscInt index1,index2,index3;
	PetscScalar ac0;
...
PetscScalar RPowerplus::getrs(PetscInt i, PetscInt j, PetscInt group, PetscScalar flux1, PetscScalar flux2, PetscScalar flux3, PetscScalar flux4, PetscScalar keff)
{
...
PetscScalar RPowerplus::getsigf(PetscInt i, PetscInt j, PetscInt group)
{
	PetscInt index;
...
PetscScalar RPowerplus::getcvv(PetscInt i, PetscInt j)
{
	PetscInt index;
...
PetscScalar RPowerplus::getdflux(PetscInt i, PetscInt j, PetscInt gdl, PetscScalar flux1, PetscScalar flux2, PetscScalar flux3, PetscScalar flux4)
{
	PetscScalar Qfd,dflux;
	PetscInt    index21,index22,index23,index24;
	PetscScalar beta[6],lamda[6]; 
