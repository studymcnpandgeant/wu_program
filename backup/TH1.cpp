...
void TH1::setinitial(PetscScalar *array1,PetscScalar *array2,PetscScalar *array3,PetscScalar *array4,PetscScalar *array5,PetscScalar *array6,PetscScalar *array7,PetscScalar *array8,PetscScalar *array9,PetscScalar *array10)
{
...
void TH1::setTHinitial(PetscScalar *array21,PetscScalar *array22,PetscScalar *array23,PetscScalar *array24,PetscScalar *array25,PetscScalar *array26)
{
...
void TH1::setparameter(PetscInt i , PetscInt j, PetscScalar Ts, PetscScalar Tf, PetscScalar P, PetscScalar U, PetscScalar V)
{
...
void TH1::setboundarycoefficient(PetscInt i, PetscInt j)
{
	PetscInt indexmtth,indexKseff,indexee,indexKf,indexROUf,indexTHd,indexTHl,indexAlpha,indexKK;
	PetscInt indexKseffx,indexKseffy,indexTHCVdxl,indexTHCVdyl,indexKx,indexKfx,indexROUfx,indexKy,indexKfy,indexROUfy; 
...
PetscScalar TH1::getTsa1(PetscInt i, PetscInt j)
{
...
PetscScalar TH1::getTsa2(PetscInt i, PetscInt j)
{
	PetscInt indexTHCVal,indexTHCVdxl,index;
	PetscScalar a2;
...
PetscScalar TH1::getTsa3(PetscInt i, PetscInt j)
{
...
PetscScalar TH1::getTsa4(PetscInt i, PetscInt j)
{
	PetscInt indexTHCVbl,indexTHCVdyl,index;
	PetscScalar a4;
...
PetscScalar TH1::getTsa0(PetscInt i, PetscInt j,PetscScalar a1,PetscScalar a2,PetscScalar a3,PetscScalar a4)
{
...
PetscScalar TH1::getTsrs(PetscInt i, PetscInt j,PetscScalar a2,PetscScalar a3,PetscScalar a4)
{
...
PetscScalar TH1::getTfa1(PetscInt i, PetscInt j)
{
...
PetscScalar TH1::getTfa2(PetscInt i, PetscInt j)
{
...
PetscScalar TH1::getTfa3(PetscInt i, PetscInt j)
{
...
PetscScalar TH1::getTfa4(PetscInt i,PetscInt j)
{
	PetscInt index;
	PetscScalar a4;
...
PetscScalar TH1::getTfa0(PetscInt i, PetscInt j,PetscScalar a1,PetscScalar a2,PetscScalar a3,PetscScalar a4)
{
	PetscInt index,indexTHCVal,indexTH;
	PetscScalar a0,Cpf;
...
PetscScalar TH1::getTfrs(PetscInt i, PetscInt j,PetscScalar a3)
{
	PetscInt index,indexTH,indexTHTs;
...
PetscScalar TH1::getUrs(PetscInt i, PetscInt j)
{
	PetscInt index,indexTH;
	PetscScalar rs;
...
PetscScalar TH1::getVrs(PetscInt i, PetscInt j)
{
	PetscInt index,indexTH;
...
PetscScalar TH1::getPa1(PetscInt i, PetscInt j)
{
	PetscInt index,indexTHCVal;
	PetscScalar a1;
...
PetscScalar TH1::getPa2(PetscInt i,PetscInt j)
{
	PetscInt index,indexTHCVal;
	PetscScalar a2;
...
PetscScalar TH1::getPa3(PetscInt i,PetscInt j)
{
	PetscInt index;
	PetscScalar a3;
...
PetscScalar TH1::getPa4(PetscInt i,PetscInt j)
{
	PetscInt index;
	PetscScalar a4;
...
PetscScalar TH1::getPa0(PetscInt i,PetscInt j, PetscScalar a1,PetscScalar a2,PetscScalar a3, PetscScalar a4)
{
	PetscScalar a0;
...
PetscScalar TH1::getPrs(PetscInt i,PetscInt j,PetscScalar a4)
{
	PetscInt index;
 ...
 /*PetscScalar TH1::getnum(PetscInt i, PetscInt j)
 {
     PetscInt index;	
