...
void RP::setinitial(PetscScalar *array1,PetscScalar *array2,PetscScalar *array3,PetscScalar *array4,PetscScalar *array5,PetscScalar *array6,PetscScalar *array7,PetscScalar *array8,PetscScalar *array9)
{
...
PetscScalar RP::geta1(PetscInt i, PetscInt j, PetscInt group)
{
...
PetscScalar RP::geta2(PetscInt i, PetscInt j, PetscInt group)
{
...
PetscScalar RP::geta3(PetscInt i, PetscInt j, PetscInt group)
{
...
PetscScalar RP::geta4(PetscInt i, PetscInt j, PetscInt group)
{
...
PetscScalar RP::geta0(PetscInt i, PetscInt j, PetscInt group, PetscScalar a1, PetscScalar a2, PetscScalar a3, PetscScalar a4)
{
	PetscInt index1,index2,index3;
	PetscScalar ac0;
...
PetscScalar RP::getrs(PetscInt i, PetscInt j, PetscInt group, PetscScalar flux1, PetscScalar flux2, PetscScalar flux3, PetscScalar flux4, PetscScalar keff)
{
