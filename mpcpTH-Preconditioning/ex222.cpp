...
int main(int argc,char **argv)
{
  ...
  /* Output the data */
  ierr = PetscViewerBinaryOpen(PETSC_COMM_WORLD,"wu_THoutmf",FILE_MODE_WRITE,&viewer);CHKERRQ(ierr);
...
PetscErrorCode FormJacobian(SNES snes,Vec U,Mat J,Mat B,void *dummy)
{
  ...
  PetscInt       Ileft,Iright,Idown,Iup,indexTH;
