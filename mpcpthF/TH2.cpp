...
void TH2::setinitial(PetscScalar *array1,PetscScalar *array2,PetscScalar *array3,PetscScalar *array4,PetscScalar *array5,PetscScalar *array6,PetscScalar *array7,PetscScalar *array8,PetscScalar *array9,PetscScalar *array10)
{
...
void TH2::setTHinitial(PetscScalar *array21,PetscScalar *array22,PetscScalar *array23,PetscScalar *array24,PetscScalar *array25,PetscScalar *array26)
{
...
void TH2::setparameter(PetscInt i , PetscInt j, PetscScalar Ts, PetscScalar Tf, PetscScalar P, PetscScalar U, PetscScalar V)
{
...
void TH2::setboundarycoefficient(PetscInt i, PetscInt j)
{
...
PetscScalar TH2::getTsa1(PetscInt i, PetscInt j)
{
...
PetscScalar TH2::getTsa2(PetscInt i, PetscInt j)
{
	PetscInt indexTHCVal,indexTHCVdxl,index;
	PetscScalar a2;
...
PetscScalar TH2::getTsa3(PetscInt i, PetscInt j)
{
...
PetscScalar TH2::getTsa4(PetscInt i, PetscInt j)
{
	PetscInt indexTHCVbl,indexTHCVdyl,index;
	PetscScalar a4;
...
PetscScalar TH2::getTsa0(PetscInt i, PetscInt j,PetscScalar a1,PetscScalar a2,PetscScalar a3,PetscScalar a4)
{
...
PetscScalar TH2::getTsrs(PetscInt i, PetscInt j,PetscScalar a2,PetscScalar a3,PetscScalar a4)
{
...
PetscScalar TH2::getTfa1(PetscInt i, PetscInt j)
{
...
PetscScalar TH2::getTfa2(PetscInt i, PetscInt j)
{
...
PetscScalar TH2::getTfa3(PetscInt i, PetscInt j)
{
...
PetscScalar TH2::getTfa4(PetscInt i,PetscInt j)
{
	PetscInt index;
	PetscScalar a4;
...
PetscScalar TH2::getTfa0(PetscInt i, PetscInt j,PetscScalar a1,PetscScalar a2,PetscScalar a3,PetscScalar a4)
{
	PetscInt index,indexTHCVal,indexTH;
	PetscScalar a0,Cpf;
...
PetscScalar TH2::getTfrs(PetscInt i, PetscInt j,PetscScalar a3)
{
...
PetscScalar TH2::getUrs(PetscInt i, PetscInt j)
{
	PetscInt index,indexTH;
	PetscScalar rs;
...
PetscScalar TH2::getVrs(PetscInt i, PetscInt j)
{
	PetscInt index,indexTH;
...
PetscScalar TH2::getPa1(PetscInt i, PetscInt j)
{
	PetscInt index,indexTHCVal;
	PetscScalar a1;
...
PetscScalar TH2::getPa2(PetscInt i,PetscInt j)
{
	PetscInt index,indexTHCVal;
	PetscScalar a2;
...
PetscScalar TH2::getPa3(PetscInt i,PetscInt j)
{
	PetscInt index;
	PetscScalar a3;
...
PetscScalar TH2::getPa4(PetscInt i,PetscInt j)
{
	PetscInt index;
	PetscScalar a4;
...
PetscScalar TH2::getPa0(PetscInt i,PetscInt j, PetscScalar a1,PetscScalar a2,PetscScalar a3, PetscScalar a4)
{
	PetscScalar a0;
...
PetscScalar TH2::getPrs(PetscInt i,PetscInt j,PetscScalar a4)
{
	PetscInt index;
...
void TH2::setCurrentVariables(const PetscScalar *u)
{
...
void TH2::setBoundaryCoefficientAll()
{
	PetscInt i,j;
